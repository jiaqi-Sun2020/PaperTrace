...
- `reader_interactive.html` only after the completed bundle passes strict reader validation
...
- formula blocks reconstructed as LaTeX display math, with noisy PDF extraction retained only as evidence or uncertainty notes
