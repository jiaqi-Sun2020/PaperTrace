...
- If the paste is clearly partial (for example abstract and intro only), build only the bounded source map for what was given, mark the missing sections in `translation_notes.md`, and do not generate HTML until the requested scope is complete.
